...
export class FaqComponent {
  tabs = [
    {  title: "What is Pro-Collagen in soft-pastilles",
      content: "A tasty fruit-based soft pastille made with an organic blend of plant nutrients and gelatine. collagen-supporting ingredients. Packed with natural antioxidants and anti-inflammatory compounds to help your body and mind stay active and healthy.",
      value: "0",
      isOpen: false 
    },
    {  title: "How do these soft-pastilles help my sensitive / ageing skin?",
      content: "These nutrient rich soft-pastilles contain natural amino acids, glycoproteins, polypeptides and ascorbate (dietary vitamin-c) to reduce skin sensitivity, strengthen joints and nails and support muscle recovery. These soft-pastilles promote natural collagen and elastin production, helping your skin look firmer, healthier, and more youthful.",
      value: "1",
      isOpen: false 
    },
    {  title: "What is Paleo-Prebiotics®?",
      content: "It’s a unique blend of ancient soluble plant fibres and resistant starches that feed your gut’s good bacteria, improving digestion, nutrient absorption and ease bowel movement. ",
      value: "2",
      isOpen: false 
    },
    {  title: "Why are MCTs included?",
      content: "MCT C8 & C10 (from virgin coconut oil) combined with ALA=Omega 3 are energy lipids that quickly refuel your brain and body, keeping you active and refreshed",
      value: "3",
      isOpen: false 
    },
    {
    ...
    },
    {
      ...
      content: "Yes! They are made without any artificial colours, sweeteners, preservatives, or hidden additives.",
      value: "5",
      isOpen: false
    },
    {
      title: "What do these soft-pastilles taste like?",
      content: "They have a naturally fruity taste from ingredients like roselle, plantain, gooseberry and soursop, making them enjoyable to take by children, active adults and older adults.",
      value: "6",
      isOpen: false
    },
    {
    ...
    },
    {
      ...
      content: "They are professionally formulated and produced in Malaysia by Utara Dietetics & Plant-Based Research in partnership with HACCP and Halal certified OEM manufacturer.",
      value: "10",
      isOpen: false
    },
    {
